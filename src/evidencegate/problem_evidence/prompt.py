...
PROMPT_VERSION = "problem-evidence-phase1-v1"
    ...
    *,
    ...
    return "\n\n".join(
        [
            ...
            "Keep evidenceIds, contradictoryEvidenceIds, and nonContributingEvidence pairwise disjoint. Use nonContributingEvidence for supplied records that remain visible but count as neither support nor contradiction. Absence is not contradiction.",
